...
class User(AbstractUser):
    ...
    author = models.ManyToManyField(Author, verbose_name='用户关注')
    article = models.ManyToManyField(Article, verbose_name='文章收藏')
    thematic = models.ManyToManyField(Thematic, verbose_name='专题收藏')
    authoruser = models.OneToOneField(Author, models.CASCADE, verbose_name="作者用户", related_name="authorusers")
