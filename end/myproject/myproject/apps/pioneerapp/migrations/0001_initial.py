    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('titleimg', models.ImageField(upload_to='articleimg', verbose_name='标题图')),
                ...
                ('likes', models.CharField(max_length=20, verbose_name='点赞数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_name', models.CharField(max_length=10, verbose_name='文章类别')),
            ],
        ),
        migrations.CreateModel(
            name='AuthorType',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_name', models.CharField(max_length=10, verbose_name='作者类别')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_name', models.CharField(max_length=10, verbose_name='专题类别')),
            ],
        ),
        migrations.CreateModel(
            name='Thematic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agree', models.CharField(max_length=20, verbose_name='赞同数')),
                ('Against', models.CharField(max_length=20, verbose_name='反对数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('introduction', models.CharField(blank=True, max_length=50, null=True, verbose_name='介绍')),
                ('avatar', models.ImageField(upload_to='authorimg', verbose_name='头像')),
        ...
        migrations.AddField(
            model_name='user',
            name='article',
            field=models.ManyToManyField(to='pioneerapp.Article', verbose_name='文章收藏'),
        ),
        migrations.AddField(
            model_name='user',
            name='author',
            field=models.ManyToManyField(to='pioneerapp.Author', verbose_name='用户关注'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='user',
            name='thematic',
            field=models.ManyToManyField(to='pioneerapp.Thematic', verbose_name='专题收藏'),
        ),
        migrations.AddField(
            model_name='user',
