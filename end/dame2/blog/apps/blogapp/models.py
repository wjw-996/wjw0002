...
class Article(models.Model):
    ...
    author = models.CharField(max_length=20, default="佚名", verbose_name="作者")
...
class Comment(models.Model):
    username = models.CharField(max_length=20, verbose_name="评论人")
    url = models.URLField(default="http://www.zzy.com", verbose_name="个人主页")
    email = models.EmailField(null=True, verbose_name="个人邮箱")
    ...
    def __str__(self):
        return self.username, self.article
